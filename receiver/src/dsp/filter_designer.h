...
// Create an IIR AC coupling filter with 2 taps
// b, a are vectors or length 2
// k = Amount of coupling. Higher k = more coupling
void create_iir_ac_filter(float* b, float* a, const float k);
...
constexpr int TOTAL_TAPS_IIR_AC_COUPLE = 2;
